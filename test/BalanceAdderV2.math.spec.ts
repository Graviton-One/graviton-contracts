...
describe('BalanceAdderV2', () => {
  ...
  describe('#EB', () => {
    it('unlocks after one week', async () => {
      ...
      expect(await balanceAdder.totalUnlocked()).to.be.eq("96044673105003010055905")          //  96044.673105003010055905
      expect(await balanceKeeper['balance(uint256)'](0)).to.be.eq("72033504828752257541928")  //  72033.504828752257541928
      expect(await balanceKeeper['balance(uint256)'](1)).to.be.eq("24011168276250752513976")  //  24011.168276250752513976
      await farmEBFor(604800)
      await balanceAdder.processBalances(2)
      expect(await farmEB.totalUnlocked()).to.be.eq("183688261375906802671116")               // 183688.261375906802671116
      expect(await balanceAdder.totalUnlocked()).to.be.eq("183688261375906802671116")         // 183688.261375906802671116
      expect(await balanceKeeper['balance(uint256)'](0)).to.be.eq("137766196031930102003336") // 137766.196031930102003336
      expect(await balanceKeeper['balance(uint256)'](1)).to.be.eq("45922065343976700667778")  //  45922.065343976700667779
    })
    ...
    it('unlocks after two weeks', async () => {
      ...
      expect(await balanceAdder.totalUnlocked()).to.be.eq("183688261375906802671116")         // 183688.261375906802671116
      expect(await balanceKeeper['balance(uint256)'](0)).to.be.eq("137766196031930102003337") // 137766.196031930102003337
      expect(await balanceKeeper['balance(uint256)'](1)).to.be.eq("45922065343976700667779")  //  45922.065343976700667779
    })
    ...
    it('unlocks after four weeks', async () => {
      ...
      expect(await balanceAdder.totalUnlocked()).to.be.eq("337826626283123222944472")         // 337826.626283123222944472
      expect(await balanceKeeper['balance(uint256)'](0)).to.be.eq("253369969712342417208354") // 253369.969712342417208354
      expect(await balanceKeeper['balance(uint256)'](1)).to.be.eq("84456656570780805736118")  //  84456.656570780805736118
    })
    ...
    it('unlocks after six months', async () => {
      ...
      expect(await balanceAdder.totalUnlocked()).to.be.eq("1123374512487256187667572")         // 337826.626283123222944472
      expect(await balanceKeeper['balance(uint256)'](0)).to.be.eq("842530884365442140750679")  // 842530.884365442140750679
      expect(await balanceKeeper['balance(uint256)'](1)).to.be.eq("280843628121814046916893")  // 280843.628121814046916893
    })
    ...
    it('unlocks after a year', async () => {
      ...
      expect(await balanceAdder.totalUnlocked()).to.be.eq("1499842209403393520254556")         // 1499842.209403393520254556
      expect(await balanceKeeper['balance(uint256)'](0)).to.be.eq("1124881657052545140190917") // 1124881.657052545140190917
      expect(await balanceKeeper['balance(uint256)'](1)).to.be.eq("374960552350848380063639")  //  374960.552350848380063639
    })
  })
  ...
  describe('#LP', () => {
    it('unlocks after one week', async () => {
      ...
      expect(await balanceAdder.totalUnlocked()).to.be.eq(expandTo18Decimals(7000))
      expect(await balanceKeeper['balance(uint256)'](0)).to.be.eq(expandTo18Decimals(5250))
      expect(await balanceKeeper['balance(uint256)'](1)).to.be.eq(expandTo18Decimals(1750))
    })
    ...
    it('unlocks after two weeks', async () => {
      ...
      expect(await balanceAdder.totalUnlocked()).to.be.eq(expandTo18Decimals(14000))
      expect(await balanceKeeper['balance(uint256)'](0)).to.be.eq(expandTo18Decimals(10500))
      expect(await balanceKeeper['balance(uint256)'](1)).to.be.eq(expandTo18Decimals(3500))
    })
    ...
    it('unlocks after four weeks', async () => {
      ...
      expect(await balanceAdder.totalUnlocked()).to.be.eq(expandTo18Decimals(28000))
      expect(await balanceKeeper['balance(uint256)'](0)).to.be.eq(expandTo18Decimals(21000))
      expect(await balanceKeeper['balance(uint256)'](1)).to.be.eq(expandTo18Decimals(7000))
    })
    ...
    it('unlocks after six months', async () => {
      ...
      expect(await balanceAdder.totalUnlocked()).to.be.eq(expandTo18Decimals(168000))
      expect(await balanceKeeper['balance(uint256)'](0)).to.be.eq(expandTo18Decimals(126000))
      expect(await balanceKeeper['balance(uint256)'](1)).to.be.eq(expandTo18Decimals(42000))
    })
    ...
    it('unlocks after a year', async () => {
      ...
      expect(await balanceAdder.totalUnlocked()).to.be.eq(expandTo18Decimals(365000))
      expect(await balanceKeeper['balance(uint256)'](0)).to.be.eq(expandTo18Decimals(273750))
      expect(await balanceKeeper['balance(uint256)'](1)).to.be.eq(expandTo18Decimals(91250))
    })
  })
  ...
  describe('#Staking', () => {
    it('unlocks after one week', async () => {
      ...
      await balanceKeeper.setCanAdd(balanceAdder.address, true)
      await balanceAdder.processBalances(2)
      expect(await farmStaking.totalUnlocked()).to.be.eq(expandTo18Decimals(7000))
      expect(await balanceAdder.totalUnlocked()).to.be.eq(expandTo18Decimals(7000))
      expect(await balanceKeeper['balance(uint256)'](0)).to.be.eq(expandTo18Decimals(5250).add(75))
      expect(await balanceKeeper['balance(uint256)'](1)).to.be.eq(expandTo18Decimals(1750).add(25))
    })
    ...
    it('unlocks after two weeks', async () => {
      ...
      await balanceKeeper.setCanAdd(balanceAdder.address, true)
      await balanceAdder.processBalances(2)
      expect(await farmStaking.totalUnlocked()).to.be.eq(expandTo18Decimals(14000))
      expect(await balanceAdder.totalUnlocked()).to.be.eq(expandTo18Decimals(14000))
      expect(await balanceKeeper['balance(uint256)'](0)).to.be.eq(expandTo18Decimals(10500).add(75))
      expect(await balanceKeeper['balance(uint256)'](1)).to.be.eq(expandTo18Decimals(3500).add(25))
    })
    ...
    it('unlocks after four weeks', async () => {
      ...
      await balanceKeeper.setCanAdd(balanceAdder.address, true)
      await balanceAdder.processBalances(2)
      expect(await farmStaking.totalUnlocked()).to.be.eq(expandTo18Decimals(28000))
      expect(await balanceAdder.totalUnlocked()).to.be.eq(expandTo18Decimals(28000))
      expect(await balanceKeeper['balance(uint256)'](0)).to.be.eq(expandTo18Decimals(21000).add(75))
      expect(await balanceKeeper['balance(uint256)'](1)).to.be.eq(expandTo18Decimals(7000).add(25))
    })
    ...
    it('unlocks after six months', async () => {
      ...
      await balanceKeeper.setCanAdd(balanceAdder.address, true)
      await balanceAdder.processBalances(2)
      expect(await farmStaking.totalUnlocked()).to.be.eq(expandTo18Decimals(168000))
      expect(await balanceAdder.totalUnlocked()).to.be.eq(expandTo18Decimals(168000))
      expect(await balanceKeeper['balance(uint256)'](0)).to.be.eq(expandTo18Decimals(126000).add(75))
      expect(await balanceKeeper['balance(uint256)'](1)).to.be.eq(expandTo18Decimals(42000).add(25))
    })
    ...
    it('unlocks after a year', async () => {
      ...
      await balanceKeeper.setCanAdd(balanceAdder.address, true)
      await balanceAdder.processBalances(2)
      expect(await farmStaking.totalUnlocked()).to.be.eq(expandTo18Decimals(365000))
      expect(await balanceAdder.totalUnlocked()).to.be.eq(expandTo18Decimals(365000))
      expect(await balanceKeeper['balance(uint256)'](0)).to.be.eq(expandTo18Decimals(273750).add(75))
      expect(await balanceKeeper['balance(uint256)'](1)).to.be.eq(expandTo18Decimals(91250).add(25))
    })
  })
  ...
  describe('#EB->Staking->EB', () => {
    it('unlocks after one week', async () => {
      ...
      await balanceKeeper.setCanAdd(balanceAdder.address, true)
      await balanceAdder.processBalances(2)
      expect(await balanceKeeper.totalBalance()).to.be.eq("96044673105003010055904")
      expect(await balanceKeeper['balance(uint256)'](0)).to.be.eq("72033504828752257541928")
      expect(await balanceKeeper['balance(uint256)'](1)).to.be.eq("24011168276250752513976")

      await balanceAdder.processBalances(2)
      expect(await balanceKeeper.totalBalance())
        .to.be.eq(BigNumber.from("96044673105003010055904")
        .add(expandTo18Decimals(7000)))
      expect(await balanceKeeper['balance(uint256)'](0))
        .to.be.eq(BigNumber.from("72033504828752257541928")
        .add(expandTo18Decimals(5250)))
      expect(await balanceKeeper['balance(uint256)'](1))
        .to.be.eq(BigNumber.from("24011168276250752513976")
  ...
  describe('#LP1->Staking->LP2', () => {
    it('unlocks after one week', async () => {
      ...
      await balanceAdder.addFarm(sharesLP2.address, farmLP2.address)
      ...
      expect(await balanceAdder.totalUnlocked()).to.be.eq(expandTo18Decimals(7000))
      expect(await balanceKeeper['balance(uint256)'](0))
        .to.be.eq(expandTo18Decimals(5250)
        .add(expandTo18Decimals(5250)))
      expect(await balanceKeeper['balance(uint256)'](1))
        .to.be.eq(expandTo18Decimals(1750)
        .add(expandTo18Decimals(1750)))
